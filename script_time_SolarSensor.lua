 --[[      Virtual Lux sensor and other real-time solar data
    ...
    -- Variables to customize ------------------------------------------------
       ...
       local idxLux ='881'            -- Your virtual Lux Device ID
       local idxSolarAzimuth ='882'       -- Your virtual Azimuth Device ID
       local idxSolarAltitude ='883'       -- Your virtual Solar Altitude Device ID
       local idxUserVarOcta='3'           -- Your user variable ID , named octa
       local wuAPIkey = "" -- Your Weather Underground API Key
       local latitude =         -- your home
       local longitude =        -- your home
       local altitude =               -- Your home altitude : run once in debug = 1 to found your altitude in Log and write it here
